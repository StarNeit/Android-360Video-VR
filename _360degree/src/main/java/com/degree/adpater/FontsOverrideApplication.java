...
public class FontsOverrideApplication extends Application {
    ...
    private static final String DEFAULT_NORMAL_BOLD_FONT_FILENAME = "Discognate.ttf";
    private static final String DEFAULT_NORMAL_BOLD_ITALIC_FONT_FILENAME = "Discognate.ttf";
    private static final String DEFAULT_NORMAL_ITALIC_FONT_FILENAME = "Discognate.ttf";
    private static final String DEFAULT_NORMAL_NORMAL_FONT_FILENAME = "Discognate.ttf";

    private static final String DEFAULT_SANS_BOLD_FONT_FILENAME = "Discognate.ttf";
    private static final String DEFAULT_SANS_BOLD_ITALIC_FONT_FILENAME = "Discognate.ttf";
    private static final String DEFAULT_SANS_ITALIC_FONT_FILENAME = "Discognate.ttf";
    private static final String DEFAULT_SANS_NORMAL_FONT_FILENAME = "Discognate.ttf";

    private static final String DEFAULT_SERIF_BOLD_FONT_FILENAME = "Discognate.ttf";
    private static final String DEFAULT_SERIF_BOLD_ITALIC_FONT_FILENAME = "Discognate.ttf";
    private static final String DEFAULT_SERIF_ITALIC_FONT_FILENAME = "Discognate.ttf";
    private static final String DEFAULT_SERIF_NORMAL_FONT_FILENAME = "Discognate.ttf";

    private static final String DEFAULT_MONOSPACE_BOLD_FONT_FILENAME = "Discognate.ttf";
    private static final String DEFAULT_MONOSPACE_BOLD_ITALIC_FONT_FILENAME = "Discognate.ttf";
    private static final String DEFAULT_MONOSPACE_ITALIC_FONT_FILENAME = "Discognate.ttf";
    private static final String DEFAULT_MONOSPACE_NORMAL_FONT_FILENAME = "Discognate.ttf";
