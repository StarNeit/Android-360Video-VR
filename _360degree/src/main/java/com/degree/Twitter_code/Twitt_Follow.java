package com.degree.Twitter_code;

import java.io.File;

import com.degree.Twitter_code.Twitter_Handler.TwDialogListener;
...
public class Twitt_Follow {
	...
	public Twitt_Follow( Activity act, String consumer_key, String consumer_secret ) {
		this.activity = act;
